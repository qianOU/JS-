...
function test(key=v()) {
    ...
    encrypt.setPublic(publickey, rsaExponent);
    devicekey = encrypt.encrypt(key);
    console.log('devicekey= ', devicekey,'\n','\n');
    console.log('deviceinfo=', i.toString());
...
//key 為初步生产的devicekey形如"0c898321fdb07086"，由以下函数生成
function v() {
    for (var t = "", e = "0123456789abcdef", r = 0; r < 16; r++)
        t += e.charAt(Math.floor(16 * Math.random()));
    return t
}
test("5ddb3cc97ac3bbd3");

getpassword('11111111')