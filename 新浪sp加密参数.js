...
function getSp(pwd){
	...
	w = f.encrypt([1567693683, "Y16GS2"].join("\t") + "\n" + b);
	return w;
}


//rsa共钥可通过'https://login.sina.com.cn/sso/prelogin.php?entry=weibo&callback=sinaSSOController.preloginCallBack&su=&rsakt=mod&client=ssologin.js(v1.4.19)&_=1567695749485'后面为时间戳 + new Date
console.log('sp = ',getSp('111111'))