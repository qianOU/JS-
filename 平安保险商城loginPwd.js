...
//ADD BY GUKUN321 2017-04-27 PAMA-ENCRYPT平台加密专用  BEGIN
function pkcs1pad2Pama(s,n) {
  if(n < s.length + 11) {
...
//PAMA密钥为1024长度，密文为512长度
function RSAEncryptPama(text) {
  var m = pkcs1pad2Pama(text,(this.n.bitLength()+7)>>3);
  if(m == null) return null;
  var c = this.doPublic(m);
  if(c == null) return null;
  var h = c.toString(16).toUpperCase();
...
RSAKey.prototype.encryptPama = RSAEncryptPama;
