...
test('http://glidedsky.com/level/web/crawler-basic-1')

# def solution2(obj,start, end):
# 	# global a;
# 	result = 0
# 	for page in range(math.ceil(start),math.ceil(end)):
...
# 		fun = threading.Thread(target=solution2, args=(quants[start],quants[start+1]))
# 		fun.start()
# 	fun.join()
# 	result = 0
# 	while True:
